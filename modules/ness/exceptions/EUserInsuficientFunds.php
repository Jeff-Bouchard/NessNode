...
class EUserInsuficientFunds extends \Exception
{
    ...
    {
        parent::__construct("User '$username' do not have enough funds(coins:$coins AND hours:$hours) at least (coins:$need_coins + 0.001 AND hours:$need_hours) needed", $code, $previous);
    }
}
