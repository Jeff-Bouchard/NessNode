...
class EConnectionError extends \Exception
{
    ...
    {
        parent::__construct("Can not connect with params (host:$config[host] port:$config[port] user:$config[user] password:$config[password] ) output message ($err)", $code, $previous);
    }
}
